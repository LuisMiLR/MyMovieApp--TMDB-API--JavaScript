...
function showMovies(data) {
    ...
    data.forEach(movie => {
        ...
        const leftMain1 = document.createElement('div');
        .className = 'sous-Main';
        main.appendChild(        const leftMain1 = document.createElement('div');
        );
        
        const sousMain1 = document.createElement('div');
        sousMain1.className = 'sous-Main';
        main.appendChild(sousMain1);
