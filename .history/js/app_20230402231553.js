...
function showMovieDetails(movieId) {
  ...
  fetch(`https://api.themoviedb.org/3/movie/${movieId}?api_key=YOUR_API_KEY&language=fr`)
    ...
    .then(data => {
      ...
      return fetch(`https://api.themoviedb.org/3/movie/${movieId}/credits?api_key=YOUR_API_KEY`);
    })
    .then(response => response.json())
    .then(data => {
